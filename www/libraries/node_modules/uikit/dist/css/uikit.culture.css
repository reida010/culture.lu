...
html {
  /* 1 */
  font-family: 'Nimbus Sans L', -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, "Noto Sans", sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Noto Color Emoji";
  font-size: 21px;
  font-weight: normal;
  line-height: 23px;
  /* 2 */
...
.uk-heading-2xlarge {
  ...
  color: #333;
  text-transform: none;
  font-family: 'Oskari G2', -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, "Noto Sans", sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Noto Color Emoji";
  font-weight: 500;
}
/* Add margin if adjacent element */
* + h1,
...
.uk-pagination > * + *:not(.uk-margin-auto-left) > * {
  border-left: 0;
}
/* Hover + Focus */
.uk-pagination > * > :hover,
